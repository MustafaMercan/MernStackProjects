...
const RecordingPage = ({configVideo}) => {
            ...
            <div className="h-full">
                ...
                <div className="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                    ...
                    <div className="w-full xl:w-3/5 p-12 overflow-hidden z-0">
                        ...
                        <ReactMediaRecorder
                            video={configVideo?.video}
                            screen={configVideo?.screen}
                            audio={configVideo?.audio}
                            render={({ status, startRecording, stopRecording, mediaBlobUrl }) => (
                                <div>
                                    ...
                                    <p>{status}</p>
                                    <button
                                        className="bg-gradient-to-r from-purple-800 to-green-500 hover:from-pink-500 hover:to-green-500 text-white font-bold py-4 px-10 rounded focus:ring transform transition hover:scale-105 duration-300 ease-in-out mx-4"
